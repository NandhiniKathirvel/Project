    ...
    public class UserController : ControllerBase
    {
        ...
        {           
            ...
            {         
                ...
                Designation = userForCreate.Designation,
            };
            ...
            return CreatedAtAction(nameof(GetById), new { id = mappedCreatedUser.EmployeeID }, mappedCreatedUser);
        }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] UserForUpdateDto userForUpdate)
        {
            var user = await _userDbService.GetById(id);
            if (user == null) return NotFound($"Cannot find User with {id} id.");
            user.Name = userForUpdate.Name;
            user.Designation = userForUpdate.Designation;
